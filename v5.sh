...
TIMES="10"
CHATID="7514935498"
KEY="8023217597:AAFcn-P7KKCvH9tmrOHMjFpNKrCR2esASF4"
...
clear; clear; clear
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "\033[96;1m              DARKNET AUTOSCRIPT                      \033[0m"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 3
...
echo -e "\e[32mloading...\e[0m"
clear
izinsc="https://raw.githubusercontent.com/johntezali56/auto-script/main/ip"
rm -f /usr/bin/user
...
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://raw.githubusercontent.com/johntezali56/auto-script/main/"
start=$(date +%s)
secs_to_human() {
...
wget raw.githubusercontent.com/johntezali56/auto-script/main/Fls/limit.sh && chmod +x limit.sh && ./limit.sh
cd
...
print_success "UDP-CUSTOM BY DARKNET VPN Installed"
clear
...
print_success "NOOBZVPNS BY DARKNET VPN Installed"
}
...
echo -e "\033[92m      INSTALLATION SUCCESSFULL     \033[0m"
echo -e "\033[96m==========================\033[0m"
echo -e ""
sleep 2
clear
echo -e "\033[93;1m Wait 2 seconds...\033[0m"
sleep 2
clear
echo ""
echo ""
